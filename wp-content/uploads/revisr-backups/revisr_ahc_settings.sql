...
LOCK TABLES `ahc_settings` WRITE;
/*!40000 ALTER TABLE `ahc_settings` DISABLE KEYS */;
INSERT INTO `ahc_settings` VALUES (1,14,15,NULL,'today_visitors');
/*!40000 ALTER TABLE `ahc_settings` ENABLE KEYS */;
UNLOCK TABLES;
