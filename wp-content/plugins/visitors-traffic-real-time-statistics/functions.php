...
function ahcfree_include_scripts() {
    ...
    wp_register_style('ahcfree_bootstrap_css', plugins_url('/lib/bootstrap/css/bootstrapcss.min.css',AHCFREE_PLUGIN_MAIN_FILE));
    ...
    wp_register_script('ahcfree_main_js', plugins_url('/js/ahc_jscripts.js', AHCFREE_PLUGIN_MAIN_FILE));
