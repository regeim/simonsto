...
function ahcfree_after_plugin_row($plugin_file, $plugin_data, $status) {
			...
			//{
				...
				echo 'You are running visitors traffic free. To get more features (<b style="color:red">GEO locations and visitors on the MAP</b>), you can <a href="https://www.wp-buy.com/product/visitors-traffic-real-time-statistics-pro/#plugins-page" target="_blank"><strong>upgrade now</strong></a> or ';
